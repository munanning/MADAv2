...
def Savefeat(cfg, writer, logger):
    ...
    torch.save(full_dataset_objective_vectors, 'features/target_full_dataset_objective_vectors_warmup.pkl')
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default='configs/CAC_from_gta_to_city_target_warmup.yml',
