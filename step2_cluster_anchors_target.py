...
def main():
    ...
    CAU = torch.load('features/target_full_dataset_objective_vectors_stage1.pkl')
    ...
    torch.save(cluster_centroids, 'anchors/cluster_centroids_sub_%d_target_stage1.pkl' % ncentroids)
    torch.save(I, 'anchors/cluster_index_sub_%d_target_stage1.pkl' % ncentroids)
