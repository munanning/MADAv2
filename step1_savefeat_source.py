...
def Savefeat(cfg, writer, logger):
    ...
    # We temporally set the GTA as the target dataset
    ...
    full_dataset_objective_vectors = np.zeros([len(datasets.source_train), 19, 256])
    ...
    torch.save(full_dataset_objective_vectors, 'features/full_dataset_objective_vectors.pkl')
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default='configs/CAC_from_gta_to_city_source.yml',
